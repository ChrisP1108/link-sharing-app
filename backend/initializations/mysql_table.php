<?php 
    ...
    // If error occurs, output error message to page
        ...
        echo '
            <script>
                document.body.outerHTML = `<body style="min-height: 100vh; display: flex; margin: 0; padding: 100px max(4%, 20px); box-sizing: border-box; background: #FAFAFA; color: #333333; font-family: Arial;"><h1 style="margin: auto; text-align: center; font-size: min(2rem, 8vw);">Error connecting to the database.<h1></body>`;
            </script>
        ';
