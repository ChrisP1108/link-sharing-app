...
<div class="profile-page-container">
    ...
    <aside class="box-section box-padding-full mobile-button-container" data-section="mobile-preview">
        <svg class="profile-mobile-preview" viewBox="0 0 308 632" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="picture-name-email-container" data-picturenameemail>
                <?php
                    ...
                    Component::form_field([
                        ...
                        'note' => 'Image must be below 1024x1024px and 750KB in size or less. Use JPG, PNG, or WEBP formats only.',
                        'required' => true,
                        'value' => ''
                    ]);
                ?>
