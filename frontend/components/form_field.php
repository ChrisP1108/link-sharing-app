<?php
    ...
    switch($icon) {
        case 'email':
            $icon_code = '<svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            break;
        case 'password':
            $icon_code = '<svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
